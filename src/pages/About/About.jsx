    ...
    <div className="about">
      ...
      <div className="aboutWrapper">
        ...
        <div className={`aboutHeader ${animationStarted ? "animation-started" : ""}`}>
          {/*<h3 className='typing green' style={{animation: "slideLeft 0.5s linear forwards"}}>HELLO, I'M YANA</h3>*/}
          <h3 className="green" style={{animation: "slideLeft 0.5s linear forwards"}}>
            <span className={`${!isMobile && "typing"} green`}>
              {" "}
              HELLO, I'M YANA
            </span>
          </h3>
          <p className="upper">I am passionate about building great web applications that meet the needs of users and
            clients alike.</p>
